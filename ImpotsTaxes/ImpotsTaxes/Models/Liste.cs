    ...
    public class Liste
    {
        ...
        */
        ...
        public List<Adress> listTown(string province)
        {
            List<Adress> lst = new List<Adress>();
            DBConnection con = new DBConnection();
            DataTable dtt = con.Data_Source("SELECT prov,town_dist from town_district where prov='" + province.Replace("'","''") + "'", "town_district");
        ...
        //LIST OF COMMUNE
        //===============
        public List<Adress> listCommune(string province, string town)
        {
            List<Adress> lst = new List<Adress>();
            DBConnection con = new DBConnection();
            DataTable dtt = con.Data_Source("SELECT prov,town_dist,commune from commune where prov ='" + province.Replace("'", "''") + "' and town_dist='" + town.Replace("'", "''") + "'", "commune");
        ...
        //LIST OF QUARTERS
        //================
        public List<Adress> listQuarter(string province, string town, string commune)
        {
            List<Adress> lst = new List<Adress>();
            DBConnection con = new DBConnection();
            DataTable dtt = con.Data_Source("SELECT prov,town_dist,commune,quarter_sect from quarter_sector where prov ='" + province.Replace("'", "''") + "' AND town_dist ='" + town.Replace("'", "''") + "' AND commune='" + commune.Replace("'", "''") + "'", "quarter_sector");
        ...
        //LIST OF QUARTERS
        //================
        public List<Adress> listAvenue(string province, string town, string commune, string quarter)
        {
            List<Adress> lst = new List<Adress>();
            DBConnection con = new DBConnection();
            DataTable dtt = con.Data_Source("SELECT prov,town_dist,commune,quarter_sect,avenue_loc from avenue_locality where prov ='" + province.Replace("'", "''") + "' AND town_dist ='" + town.Replace("'", "''") + "' AND commune ='" + commune.Replace("'", "''") + "' AND quarter_sect='" + quarter.Replace("'", "''") + "'", "avenue_locality");
